...
This application allows a user to search for a product's name and price from the 8-digit product ID.  The information is pulled from the Target RedSky API as well as a NoSQL data store.
> View deployed application: [myRetail Product Search](https://myretail-product-search.herokuapp.com/)
